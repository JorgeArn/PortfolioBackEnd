...
public class UsuarioPrincipal implements UserDetails {
    ...
    //Constructor
    public UsuarioPrincipal(String nombre, String nombreUsuario, String correo, String password, Collection<? extends GrantedAuthority> authorities) {
        this.nombre = nombre;
    ...
    public static UsuarioPrincipal build(Usuarios usuarios) {
        ...
        return new UsuarioPrincipal(usuarios.getNombre(), usuarios.getNombreUsuario(), usuarios.getCorreo(), usuarios.getPassword(), authorities);
    }
